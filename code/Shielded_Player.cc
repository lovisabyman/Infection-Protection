...
Shielded_Player::Shielded_Player(Position& start_position)
{
...
void Shielded_Player::update(std::map <std::string, bool> & inputs,
...
bool Shielded_Player::handle_collision(Object* next, std::vector <Object*> &)
{
